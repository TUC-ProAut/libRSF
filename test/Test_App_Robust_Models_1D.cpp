...
TEST(App_Robust_Models_1D, MaxSumMix)
{
  ...
  for (int kPose = 0; kPose<nPointsPerDim; kPose++)
  {
      Expected.addElement(libRSF::Data("point1 1.0 "+mean+" 0.0"));
  }
  
  double maxAbsErrorMean = libRSF::MaxAbsError(libRSF::DataType::Point1,
                                                     Expected,
                                                     POSITION_STATE,
