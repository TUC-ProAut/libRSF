...
/**
* @file Example_Robust_Models_1D.cpp
* @author Tim Pfeifer
* @date 26.08.2019
...
//  SolverOptions.trust_region_problem_dump_format_type = ceres::DumpFormatType::TEXTFILE;
  ...
  for (int nPoint = 0; nPoint < NumberPoints; nPoint++)
  {
    ...
    SolverData.getElement(SOLVE_TIME_STATE, 0.0, nPoint).setValueScalar(libRSF::StateElement::DurationSolver, SimpleGraph.getSolverDurationAndReset());
    SolverData.getElement(SOLVE_TIME_STATE, 0.0, nPoint).setValueScalar(libRSF::StateElement::IterationSolver, SimpleGraph.getSolverIterationsAndReset());
