...
* @author Tim Pfeifer
* @date 16.02.2022
* @brief Header for a simple application to evaluate the robust error functions in 3D and the corresponding test.
* @copyright GNU Public License.
*
*/

#ifndef APP_ROBUST_MODELS_3D_H_INCLUDED
#define APP_ROBUST_MODELS_3D_H_INCLUDED
...
#endif // APP_ROBUST_MODELS_3D_H_INCLUDED
