The smartLoc Dataset - Postprocessed with the RTKLIB using the gnss_converter (https://github.com/TUC-ProAut/gnss_converter)

Copyright 2016-2022 by Pierre Reisdorf, Tim Pfeifer, Julia Breßler, Sven Bauer, Peter Weissig, Sven Lange (TU Chemnitz)
