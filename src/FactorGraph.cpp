...
namespace libRSF
{
  ...
  void FactorGraph::initValues(FactorType CurrentFactorType, std::vector<StateID> &StateList, const SensorData &Measurement, double DeltaTime)
  {
    ...
    {
      case FactorType::BetweenPose3:
        RelativePose3Model<double>::applyForward(StatePointers[0],
            StatePointers[1],
            StatePointers[2],
            StatePointers[3],
            Measurement.getMean().head(3),
            VectorToQuaternion<double>(Measurement.getMean().tail(4)));
        break;

      case FactorType::ConstVal1:
        PredictConstantValue<double, 1>(StatePointers[0], StatePointers[1]);
        break;

      case FactorType::ConstVal2:
        PredictConstantValue<double, 2>(StatePointers[0], StatePointers[1]);
        break;

      case FactorType::ConstVal3:
        PredictConstantValue<double, 3>(StatePointers[0], StatePointers[1]);
        break;
      ...
      case FactorType::ConstDrift2:
        PredictConstantDrift<double, 2>(StatePointers[0],
                                        StatePointers[1],
                                        StatePointers[2],
                                        StatePointers[3],
                                        DeltaTime);
      ...
      case FactorType::ConstDrift3:
        PredictConstantDrift<double, 3>(StatePointers[0],
                                        StatePointers[1],
                                        StatePointers[2],
                                        StatePointers[3],
                                        DeltaTime);
      ...
      case FactorType::Odom2:
        PredictOdometry2<double>(StatePointers[0],
                                 StatePointers[1],
                                 StatePointers[2],
                                 StatePointers[3],
                                 Measurement.getMean(),
      ...
      case FactorType::Odom2Diff:
        PredictMotionDifferential2D<double>(StatePointers[0],
                                            ...
                                            StatePointers[3],
                                            Measurement.getMean(),
                                            Measurement.getValue(SensorElement::WheelBase)[0],
                                            DeltaTime);
        break;
